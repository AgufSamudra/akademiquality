...
const pageUrl = "/training-iso-14001-online-murah-bersertifikat";
const whatsappHref =
  "https://wa.me/6289507639360?text=Hallo%20Akademi%20Quality%2C%20saya%20ingin%20konsultasi%20Training%20ISO%2014001.";

export const metadata: Metadata = {
  title: "Training ISO 14001:2015 - Manajemen Lingkungan Online Bersertifikat",
  description:
    "Training ISO 14001:2015 Sistem Manajemen Lingkungan Online dengan harga murah dan terjangkau. Provider ISO Top Indonesia.",
  keywords: [
    "training ISO 14001",
    "pelatihan ISO 14001",
    "training ISO 14001 online",
    "pelatihan ISO 14001 bersertifikat",
  ...
  openGraph: {
    title: "Training ISO 14001:2015 - Manajemen Lingkungan Online Bersertifikat",
    description:
      "Pelatihan ISO 14001:2015 Sistem Manajemen Lingkungan dengan metode online, offline, dan inhouse bersama trainer berpengalaman.",
    url: pageUrl,
    images: [
      {
        url: "/ISO-14001.png",
        width: 1200,
        height: 630,
        alt: "Training ISO 14001 Akademi Quality",
      },
    ],
  },
};
...
const learningOutcomes = [
  "Memahami prinsip dasar Sistem Manajemen Lingkungan ISO 14001:2015.",
  "Membaca klausul ISO 14001 dan menghubungkannya dengan proses operasional.",
  "Mengidentifikasi aspek lingkungan, dampak lingkungan, risiko, dan peluang.",
  "Menyiapkan dokumentasi, bukti kepatuhan, dan kesiapan audit lingkungan.",
  "Menerapkan pendekatan peningkatan berkelanjutan untuk kinerja lingkungan.",
];
...
const modules = [
  ...
  "Prinsip-Prinsip Manajemen Lingkungan",
...
const faqItems = [
  [
    "Apa itu Training ISO 14001:2015?",
    "Training ISO 14001:2015 adalah pelatihan Sistem Manajemen Lingkungan yang membantu peserta memahami persyaratan standar, aspek dan dampak lingkungan, kewajiban kepatuhan, dokumentasi, audit, dan peningkatan berkelanjutan.",
  ],
  [
    "Apakah training ini bisa diikuti pemula?",
    "Bisa. Materi disusun bertahap dari pengenalan ISO 14001, lingkup, terminologi, prinsip manajemen lingkungan, sampai contoh penerapan di organisasi.",
  ],
  [
...
export default function Iso14001TrainingDetailPage() {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Course",
    name: "Training ISO 14001:2015 - Manajemen Lingkungan Online Bersertifikat",
    description:
      "Training ISO 14001:2015 Sistem Manajemen Lingkungan dengan metode online, offline, dan inhouse bersama Akademi Quality.",
    provider: {
      "@type": "Organization",
        ...
        <div className="relative mx-auto grid max-w-[1200px] items-center gap-12 md:grid-cols-[1.02fr_0.98fr]">
          <div>
            ...
            <h1 className="mt-5 max-w-[760px] text-[42px] font-semibold leading-[1.05] tracking-tight md:text-[70px]">
              Sistem Manajemen Lingkungan - Murah Terjangkau
            </h1>
            <p className="mt-6 max-w-[680px] text-[17px] leading-[1.75] text-white/78 md:text-[18px]">
              Pelatihan ISO 14001:2015 untuk membantu profesional dan
              perusahaan memahami sistem manajemen lingkungan, kewajiban
              kepatuhan, dokumentasi, dan peningkatan kinerja lingkungan.
            </p>
      ...
      <section className="px-5 py-16 md:px-10 md:py-24">
        <div className="mx-auto grid max-w-[1120px] items-start gap-10 lg:grid-cols-[0.88fr_1.12fr]">
          <div>
            <SectionTitle
              centered={false}
              eyebrow="Tentang ISO 14001:2015"
              title="Standar sistem manajemen lingkungan untuk organisasi yang bertanggung jawab."
            />
            <p className="mt-5 text-[16px] leading-[1.85] text-[#444040]">
              Dalam era globalisasi dan persaingan industri yang semakin
              ketat, manajemen lingkungan dan keberlanjutan menjadi dua pilar
              penting yang menentukan kesuksesan sebuah organisasi. ISO
              14001:2015 merupakan standar internasional yang menetapkan
              persyaratan untuk sistem manajemen lingkungan.
            </p>
            <p className="mt-4 text-[16px] leading-[1.85] text-[#444040]">
              Adopsi dan sertifikasi ISO 14001 tidak hanya menunjukkan
              komitmen terhadap keberlanjutan lingkungan, tetapi juga
              memperkuat posisi organisasi di pasar global sebagai organisasi
              yang bertanggung jawab dan profesional.
            </p>
            <p className="mt-4 text-[16px] leading-[1.85] text-[#444040]">
              Organisasi yang terakreditasi ISO 14001 diakui memiliki sistem
              manajemen lingkungan yang handal, memastikan operasi meminimalkan
              dampak negatif terhadap lingkungan dan mematuhi persyaratan
          ...
          <div className="mt-16 grid items-start gap-8 rounded-[30px] border border-black/10 bg-[#f8f7f5] px-5 py-8 md:px-8 lg:grid-cols-[0.86fr_1.14fr]">
            <div>
              ...
              <p className="mt-5 text-[16px] leading-[1.8] text-[#444040]">
                ...
                individu yang ingin memahami pentingnya ISO 14001.
              </p>
              <a
