...
const pageUrl = "/training-iso-9001-online-bersertifikat";
const whatsappHref =
  "https://wa.me/6289507639360?text=Hallo%20Akademi%20Quality%2C%20saya%20ingin%20konsultasi%20Training%20ISO%209001.";

export const metadata: Metadata = {
  title: "Training ISO 9001:2015 - Online Bersertifikat",
  description:
    "Training ISO 9001:2015 Sistem Manajemen Mutu dengan harga terjangkau, bersertifikat, tersedia online, offline, inhouse online, dan inhouse offline.",
  keywords: [
    "training ISO 9001",
    "pelatihan ISO 9001",
    "training ISO 9001 online",
    "pelatihan ISO 9001 bersertifikat",
  ...
  openGraph: {
    title: "Training ISO 9001:2015 - Online Bersertifikat",
    description:
      "Pelatihan ISO 9001:2015 Sistem Manajemen Mutu dengan metode online, offline, dan inhouse bersama trainer berpengalaman.",
    url: pageUrl,
    images: [
      {
        url: "/ISO-9001.png",
        width: 1200,
        height: 630,
        alt: "Training ISO 9001 Akademi Quality",
      },
    ],
  },
};
...
const learningOutcomes = [
  "Memahami prinsip dasar Sistem Manajemen Mutu ISO 9001:2015.",
  "Membaca klausul ISO 9001 dan menghubungkannya dengan proses kerja.",
  "Mengidentifikasi risiko, peluang, dan kebutuhan perbaikan proses.",
  "Menyiapkan dokumentasi, bukti kerja, dan kesiapan audit internal.",
  "Menerapkan pendekatan perbaikan berkelanjutan di organisasi.",
];

const modules = [
  "Pengenalan ISO 9001:2015 dan manfaat sistem manajemen mutu",
  "Konteks organisasi, kebutuhan pihak berkepentingan, dan ruang lingkup",
  "Leadership, kebijakan mutu, sasaran mutu, serta peran tim",
  "Perencanaan risiko, peluang, perubahan, dan objective quality",
  "Support process: kompetensi, awareness, komunikasi, dan dokumentasi",
  "Operation process, kontrol layanan, dan pengendalian ketidaksesuaian",
  "Evaluasi kinerja, audit internal, tinjauan manajemen, dan improvement",
];
...
const faqItems = [
  [
    "Apa itu Training ISO 9001:2015?",
    "Training ISO 9001:2015 adalah pelatihan Sistem Manajemen Mutu yang membantu peserta memahami persyaratan standar, penerapan proses, dokumentasi, audit, dan perbaikan berkelanjutan.",
  ],
  [
    "Apakah training ini bisa diikuti pemula?",
    "Bisa. Materi disusun bertahap dari pengenalan standar sampai contoh penerapan, sehingga cocok untuk pemula, profesional, mahasiswa, maupun tim perusahaan.",
  ],
  [
  ...
  [
    ...
    "Peserta mendapatkan materi pelatihan, e-sertifikat, quiz test, dukungan komunitas, dan fasilitas pendukung seperti recording untuk kelas online.",
  ],
];
...
export default function Iso9001TrainingDetailPage() {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Course",
    name: "Training ISO 9001:2015 - Online Bersertifikat",
    description:
      "Training ISO 9001:2015 Sistem Manajemen Mutu dengan metode online, offline, dan inhouse bersama Akademi Quality.",
    provider: {
      "@type": "Organization",
        ...
        <div className="relative mx-auto grid max-w-[1200px] items-center gap-12 md:grid-cols-[1.02fr_0.98fr]">
          <div>
            ...
            <h1 className="mt-5 max-w-[760px] text-[42px] font-semibold leading-[1.05] tracking-tight md:text-[70px]">
              Sistem Manajemen Mutu - Murah Terjangkau
            </h1>
            <p className="mt-6 max-w-[680px] text-[17px] leading-[1.75] text-white/78 md:text-[18px]">
              Pelatihan ISO 9001:2015 untuk membantu profesional dan perusahaan
              memahami sistem manajemen mutu, kesiapan audit, dokumentasi, dan
      ...
      <section className="px-5 py-16 md:px-10 md:py-24">
        <div className="mx-auto grid max-w-[1120px] items-start gap-10 lg:grid-cols-[0.88fr_1.12fr]">
          <div>
            <SectionTitle
              centered={false}
              eyebrow="Tentang ISO 9001:2015"
              title="Standar mutu untuk proses kerja yang konsisten."
            />
            <p className="mt-5 text-[16px] leading-[1.85] text-[#444040]">
              ISO 9001:2015 adalah standar sistem manajemen mutu yang membantu
              organisasi mengelola proses, risiko, sasaran mutu, kepuasan
              pelanggan, dan peningkatan berkelanjutan secara terstruktur.
            </p>
            <p className="mt-4 text-[16px] leading-[1.85] text-[#444040]">
              Training ini dirancang agar peserta bukan hanya mengenal klausul,
              tetapi juga memahami cara menerapkannya dalam pekerjaan harian dan
              kebutuhan audit.
            </p>
          </div>
          ...
          <div className="mt-16 grid items-start gap-8 rounded-[30px] border border-black/10 bg-[#f8f7f5] px-5 py-8 md:px-8 lg:grid-cols-[0.86fr_1.14fr]">
            <div>
              ...
              <p className="mt-5 text-[16px] leading-[1.8] text-[#444040]">
                ...
                individu yang ingin memahami pentingnya ISO 9001.
              </p>
              <a
